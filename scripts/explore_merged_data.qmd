...
# Commitments by channel type  
  ...
  commit.channel_nonstate_multi = sum(usd_commitment_defl[channel_nonstate_multi=="1"], na.rm = T),
# Extensive margin
  n_sector = uniqueN(sector_id[usd_commitment_defl > 0]),
  n_purpose = uniqueN(purpose_id[usd_commitment_defl > 0]),
  n_projects = uniqueN(crs_id[usd_commitment_defl > 0], na.rm = T)
...
# Level trend (commitment)

data_sample <- between_periods_comparison |> 
...
ggwithinstats(
  data = data |> select(group, period, outcome),
  x    = period,
  y    = outcome,
  type = "np",
  ylab = "Millions, USD", 
  title = "Commitments delivered through non-State channels",
  subtitle = "within-subjects comparisons"
)

## Change trend
# First difference
ggwithinstats(
  data = data |> select(group, period, diff),
  x    = period,
  y    = diff,
  type = "np",
  ylab = "Millions, USD", 
  title = "First diff. of commitments delivered through non-State channels",
  subtitle = "within-subjects comparisons"
)
# Ratio (t/t-1)
ggwithinstats(
  data = data |> select(group, period, ratio),
  x    = period,
  y    = ratio,
  type = "np",
  title = "Ratio between commitments delivered through non-State channels in t and t-1",
  subtitle = "within-subjects comparisons",
  caption = "Note: increase when ratio > 1 "
)
...
ggwithinstats(
  ...
  type = "np",
  ylab = "Millions, USD", 
  title = "Commitments delivered through NGOs",
  subtitle = "within-subjects comparisons"
)
...
ggwithinstats(
  ...
  type = "np",
  ylab = "Millions, USD", 
  title = "First diff. of commitments delivered through NGOs",
  subtitle = "within-subjects comparisons"
)
# Ratio (t/t-1)
ggwithinstats(
  ...
  y    = ratio,
  type = "np",
  title = "Ratio between commitments delivered through NGOs in t and t-1",
  subtitle = "within-subjects comparisons",
  caption = "Note: increase when ratio > 1 "
)
...
ggwithinstats(
  ...
  type = "np",
  ylab = "Millions, USD", 
  title = "Commitments delivered through Multilaterals",
  subtitle = "within-subjects comparisons"
)
...
ggwithinstats(
  ...
  type = "np",
  ylab = "Millions, USD", 
  title = "First diff. of commitments delivered through Multilaterals",
  subtitle = "within-subjects comparisons"
)
# Ratio (t/t-1)
ggwithinstats(
  ...
  y    = ratio,
  type = "np",
  title = "Ratio between commitments delivered through Multilaterals in t and t-1",
  subtitle = "within-subjects comparisons",
  caption = "Note: increase when ratio > 1 "
)
...
ggwithinstats(
  ...
  type = "np",
  ylab = "%", 
  title = "Share of commitments delivery through non-State channeled",
  subtitle = "within-subjects comparisons"
)
...
ggwithinstats(
  ...
  type = "np",
  ylab = "%", 
  title = "Share of commitments delivery through NGOs",
  subtitle = "within-subjects comparisons"
)

```

### non-State: Multilaterals
...
ggwithinstats(
  ...
  type = "np",
  ylab = "%", 
  title = "Share of commitments delivery through Multilaterals",
  subtitle = "within-subjects comparisons"
)
...
data_sample <- facet_donor |> 
  select(bi_multi, donor_id, recipient_id, outcome, diff, period) |> 
  fmutate(group = paste(donor_id, recipient_id, sep = "_")) |> 
  filter(period %in% c(-3:3))

# Level trend

test <- data_sample[outcome > 0,
][, .(
    N = uniqueN(group),
    min = min(outcome, na.rm = T),
...
ggplot(test, aes(x=period)) +
  geom_point(aes(y=median), shape=1) +
  geom_point(aes(y=mean), shape=4) +
  geom_linerange(aes(ymin=Q1, ymax=Q3)) +
  geom_hline(yintercept = 0, linetype="dashed", color="grey") +
  geom_vline(xintercept = 0, linetype="dotted", color="coral") +
  facet_wrap(~bi_multi) +
  theme_minimal() +
  labs(
    title = "Share of commitments delivered through non-State channels",
    caption = "Median (circle), Mean (cross), Q1-Q3 (line range)",
    y="% commitments")
...
test <- data_sample[, .(
    ...
    Q1 = quantile(diff, probs = .25, na.rm = T),
    median = median(diff, na.rm = T), 
    mean = mean(diff, na.rm = T),
    Q3 = quantile(diff, .75, na.rm = T),
...
data_sample <- facet_recip |> 
  select(incomegroup = incomegroup_name, donor_id, recipient_id, outcome, diff, period) |> 
  fmutate(group = paste(donor_id, recipient_id, sep = "_"))
...
test <- data_sample[outcome > 0,
    ...
    Q3 = quantile(outcome, .75, na.rm = T),
    max = max(outcome, na.rm = T)
), by = .(incomegroup, period)
][order(incomegroup, period)]
...
ggwithinstats(
  ...
  type = "np",
  ylab = "# of projects", 
  title = "First diff. of the number of projects",
  subtitle = "within-subjects comparisons"
)
# Ratio (t/t-1)
ggwithinstats(
  ...
  type = "np",
  ylab = "Ratio", 
  title = "Ratio between # projects in t and t-1",
  subtitle = "within-subjects comparisons",
  caption = "Note: increase when ratio > 1 "
)
...
ggwithinstats(
  ...
  type = "np",
  ylab = "# of purposes", 
  title = "First diff. of the number of purposes",
  subtitle = "within-subjects comparisons"
)
# Ratio (t/t-1)
ggwithinstats(
  ...
  type = "np",
  ylab = "Ratio", 
  title = "Ratio between # purposes in t and t-1",
  subtitle = "within-subjects comparisons",
  caption = "Note: increase when ratio > 1 "
)
...
ggwithinstats(
  ...
  y    = outcome,
  type = "np",
  ylab = "Millions, USD (log10)", 
  title = "Avg size of projects"
)

## Change trend
# First difference
ggwithinstats(
  data = data |> select(group, period, diff, outcome),
  x    = period,
  y    = diff,
  type = "np",
  ylab = "Millions, USD", 
  title = "First diff. of the avg size of projects"
)

```

# Unit-level: sector-recipient-year
