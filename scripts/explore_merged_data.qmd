...
ggplot(data, aes(x = diff)) +
  ...
  theme_minimal() +
  labs(title="Distribution of yearly changes in commitments to affected countries\ntwo periods pre/post-disaster",
       subtitle="Outlier = Ukraine",
       x="Commitments (USD, Millions)",
...
ggbetweenstats(
  ...
  title = "Yearly changes in commitments to affected countries\ntwo periods pre/post-disaster",
